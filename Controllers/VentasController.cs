...
namespace DepositoDental.Controllers
{
    public class VentasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClienteId,Fecha")] Venta venta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClienteId,Fecha")] Venta venta)
        {
            if (id != venta.Id)
            {
                return NotFound();
