...
namespace DepositoDental.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Precio,Stock,ProveedorId")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Precio,Stock,ProveedorId")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
